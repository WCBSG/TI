...
{
	uint8 i;
	volatile uint8 far *intf_reg = (volatile uint8 far *)(0x7efd10 + 0x00);//�����ж϶˿�
...
{
	uint8 i;
	volatile uint8 far *intf_reg = (volatile uint8 far *)(0x7efd10 + 0x01);//�����ж϶˿�
	uint8 flags = *intf_reg;
	*intf_reg &= ~flags;
...
{
	uint8 i;
	volatile uint8 far *intf_reg = (volatile uint8 far *)(0x7efd10 + 0x02);//�����ж϶˿�
	uint8 flags = *intf_reg;
	*intf_reg &= ~flags;
...
{
	uint8 i;
	volatile uint8 far *intf_reg = (volatile uint8 far *)(0x7efd10 + 0x03);//�����ж϶˿�
	uint8 flags = *intf_reg;
	*intf_reg &= ~flags;
...
{
	uint8 i;
	volatile uint8 far *intf_reg = (volatile uint8 far *)(0x7efd10 + 0x04);//�����ж϶˿�
	uint8 flags = *intf_reg;
	*intf_reg &= ~flags;
...
{
	uint8 i;
	volatile uint8 far *intf_reg = (volatile uint8 far *)(0x7efd10 + 0x05);//�����ж϶˿�
	uint8 flags = *intf_reg;
	*intf_reg &= ~flags;
...
{
	uint8 i;
	volatile uint8 far *intf_reg = (volatile uint8 far *)(0x7efd10 + 0x06);//�����ж϶˿�
	uint8 flags = *intf_reg;
	*intf_reg &= ~flags;
...
{
	uint8 i;
	volatile uint8 far *intf_reg = (volatile uint8 far *)(0x7efd10 + 0x07);//�����ж϶˿�
	uint8 flags = *intf_reg;
	*intf_reg &= ~flags;
...
{
	uint8 i;
	volatile uint8 far *intf_reg = (volatile uint8 far *)(0x7efd10 + 0x08);//�����ж϶˿�
	uint8 flags = *intf_reg;
	*intf_reg &= ~flags;
...
{
	uint8 i;
	volatile uint8 far *intf_reg = (volatile uint8 far *)(0x7efd10 + 0x09);//�����ж϶˿�
	uint8 flags = *intf_reg;
	*intf_reg &= ~flags;
...
{
	uint8 i;
	volatile uint8 far *intf_reg = (volatile uint8 far *)(0x7efd10 + 0x0a);//�����ж϶˿�
	uint8 flags = *intf_reg;
	*intf_reg &= ~flags;
...
{
	uint8 i;
	volatile uint8 far *intf_reg = (volatile uint8 far *)(0x7efd10 + 0x0b);//�����ж϶˿�
	uint8 flags = *intf_reg;
	*intf_reg &= ~flags;
...
//void INT1_IRQHandler(void) interrupt INT1_VECTOR  //�ⲿ�ж�1��Ĭ����������ͷ
...
{
    if (DMA_UR5R_STA & 0x01) // �������
    {
        DMA_UR5R_STA &= ~0x01;      // ���־λ
        uart_rx_start_buff(UART_5); // ������һ�ν��գ���ر���
...
{
    if (DMA_UR6R_STA & 0x01) // �������
    {
        DMA_UR6R_STA &= ~0x01;      // ���־λ
        uart_rx_start_buff(UART_6); // ������һ�ν��գ���ر���
...
{
    if (DMA_UR7R_STA & 0x01) // �������
    {
        DMA_UR7R_STA &= ~0x01;      // ���־λ
        uart_rx_start_buff(UART_7); // ������һ�ν��գ���ر���
...
{
    if (DMA_UR8R_STA & 0x01) // �������
    {
        DMA_UR8R_STA &= ~0x01;      // ���־λ
        uart_rx_start_buff(UART_8); // ������һ�ν��գ���ر���
