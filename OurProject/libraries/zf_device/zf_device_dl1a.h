...
#define DL1A_USE_INTERFACE           (SOFT_IIC)                    			// 默认使用软件 IIC 方式驱动 建议使用软件 IIC 方式
#if (DL1A_USE_INTERFACE==SOFT_IIC)                                 			// 这两段 颜色正常的才是正确的 颜色灰的就是没有用的
//====================================================软件 IIC 驱动====================================================
	#define DL1A_SOFT_IIC_DELAY         ( 1 )                         		// 软件 IIC 的时钟延时周期 数值越小 IIC 通信速率越快
	#define DL1A_SCL_PIN                ( IO_P61 )                    		// 软件 IIC SCL 引脚 连接 DL1A 的 SCL 引脚
	#define DL1A_SDA_PIN                ( IO_P63 )                    		// 软件 IIC SDA 引脚 连接 DL1A 的 SDA 引脚
//====================================================软件 IIC 驱动====================================================
...
#if DL1A_INT_ENABLE
	#define DL1A_INT_PIN            ( GPIO_INIT_P84 )						// 未定义引脚，可以不接。
#endif
